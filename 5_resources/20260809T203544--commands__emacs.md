...
| C-x C-w         | write buffer / save as                | write buffer                               |
...
| C-h k           | help key                              |                                            |
| C-u             | universal argument or prefix argument | usualy for repeat                          |
| M-x eval-buffer | evaluate entire buffer                | usful for editring config                  |
| M-x eval-region | eval the region                       |                                            |
| C-h a           | apropos                               | search functions, variable, commands       |
